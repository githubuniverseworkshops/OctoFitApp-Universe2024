...
> :blue_book: **NOTE**: Because we have only 20 minutes for the actual workshop, it is possible that we cannot complete everything. However, we will have the value of troubleshooting together, and there is also a [self-paced exercise](https://reimagined-adventure-1pgkjkp.pages.github.io/) if you want to follow along later.
